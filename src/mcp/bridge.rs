...
fn wait_for_project_object_preload(
    tx: &Sender<OdonControlRequest>,
    ctx: &egui::Context,
    session_id: &str,
    event_hub: &Arc<EventHub>,
...
fn wait_for_mosaic_object_load(
    tx: &Sender<OdonControlRequest>,
    ctx: &egui::Context,
    session_id: &str,
    event_hub: &Arc<EventHub>,
...
fn wait_for_deep_link_application(
    tx: &Sender<OdonControlRequest>,
    ctx: &egui::Context,
    session_id: &str,
    event_hub: &Arc<EventHub>,
...
fn wait_for_object_property_load(
    initial: &Value,
    tx: &Sender<OdonControlRequest>,
    ctx: &egui::Context,
    session_id: &str,
...
fn wait_for_object_source_load(
    tx: &Sender<OdonControlRequest>,
    ctx: &egui::Context,
    session_id: &str,
    event_hub: &Arc<EventHub>,
