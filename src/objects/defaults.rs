...
impl Default for ObjectsLayer {
    fn default() -> Self {
        Self {
            ...
            render_style_cache_id: next_object_render_style_cache_id(),
            ...
            lazy_property_cache_capacity: None,
            lazy_property_lru: VecDeque::new(),
            lazy_property_cache_evictions: 0,
            ...
            presentation_state_cache: ObjectPresentationStateCache::default(),
            outline_mode_runtime: ObjectOutlineModeRuntime::default(),
            outline_frame_stats: ObjectOutlineFrameStats::default(),
