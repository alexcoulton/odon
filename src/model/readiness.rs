...
impl OperationKind {
    pub(crate) const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::DeepLinkApply => "deep_link_apply",
            Self::ProjectIo => "project_io",
            Self::ProjectObjectPreload => "project_object_preload",
            Self::ProjectRoiOpen => "project_roi_open",
            Self::ProjectViewApply => "project_view_apply",
            Self::Labels => "labels",
            Self::Annotations => "annotations",
            Self::Objects => "objects",
            Self::SegmentationGeoJson => "segmentation_geojson",
            ...
            Self::ChannelCompute => "channel_compute",
