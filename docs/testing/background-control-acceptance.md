...
- Rust `odon` binary: 187 passed, 0 failed, 4 tests intentionally ignored by the latest cumulative run; the frame-planning benchmark was previously run explicitly and passed, while three extended-fixture tests remain unavailable.
