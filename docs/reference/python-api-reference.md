...
| `get_tile_loading() -> 'Any'` | `memory.tiles.get` | single, mosaic | Inspect tile workers, byte-accounted image cache occupancy, target level, and prefetch policy. (completion: immediate_semantic) |
| `set_tile_loading(*, workers: 'int \| None' = None, prefetch_mode: 'str \| None' = None, prefetch_aggressiveness: 'str \| None' = None, prefer_pinned_finer_levels: 'bool \| None' = None, cache_mode: 'str \| None' = None, cache_budget_bytes: 'int \| None' = None, channel_history: 'str \| None' = None, if_revision: 'int \| None' = None) -> 'Any'` | `memory.tiles.set` | single, mosaic | Set tile workers, prefetch, image cache byte budget, channel history, and pinned-level fallback. (mutates; completion: immediate_semantic; event: memory.tiles.changed) |
...
| `get_object_property_cache() -> 'Any'` | `mosaic.objects.property_cache.get` | mosaic | Get the lazy mosaic object-property retention policy. (completion: immediate_semantic) |
| `set_object_property_cache(*, policy: 'str' = 'lru', capacity: 'int \| None' = 2, if_revision: 'int \| None' = None) -> 'Any'` | `mosaic.objects.property_cache.set` | mosaic | Bound lazily loaded mosaic properties without unloading object geometry. (mutates; completion: immediate_semantic; event: mosaic.objects.changed) |
