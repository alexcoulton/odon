...
| Threshold analysis | `threshold_region_min_pixels`, `threshold_region_scope`, `threshold_region_full_level`, `threshold_region_status`, `threshold_region_preview` | Legacy compute parameters and projected preview | Actor retained compute task plus shared result; renderer consumes the projected preview; Milestone 5 |
