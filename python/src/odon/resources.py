...
class Viewport:
    """A stable handle to one native Odon viewport."""

    def __init__(self, client: "Client", viewport_id: str) -> None:
        self._client = client
        self.id = viewport_id
        self.objects = ViewportObjects(self)

    def get(self) -> Any:
        return self._client.call("viewer.viewports.get", {"viewport_id": self.id})

    def set_active(self, *, if_revision: int | None = None) -> Any:
        return self._client.call(
    ...
    def remove(self, *, if_revision: int | None = None) -> Any:
        return self._client.call(
    ...
    def list_channel_groups(self) -> Any:
        return self._client.call(
    ...
    def get_object_filter(self) -> Any:
        return self._client.call(
...
class ViewportObjects:
    """Object presentation and filter resource bound to one stable viewport."""

    def __init__(self, viewport: Viewport) -> None:
        self._viewport = viewport

    def get_style(self) -> Any:
        return self._viewport.get_object_style()
    ...
    def set_legend(
        ...
        *,
        ...
        return self._viewport.set_object_legend(
            entries,
            if_revision=if_revision,
            if_presentation_revision=if_presentation_revision,
        )
    ...
    def get_filter(self) -> Any:
        return self._viewport.get_object_filter()
    ...
    def set_filter(
        ...
        *,
        ...
        return self._viewport.set_object_filter(
            query,
            mode=mode,
            clauses=clauses,
            logic=logic,
    ...
    def clear_filter(
        ...
        *,
        ...
        return self._viewport.clear_object_filter(
            if_revision=if_revision,
            if_presentation_revision=if_presentation_revision,
        )
...
class ViewportComparison:
    def __init__(self, left: Viewport, right: Viewport) -> None:
        self.left = left
        self.right = right
...
class ViewportWorkspace:
    ...
    def get(self) -> Any:
        return self._client.call("viewer.workspace.get")

    def get_layout(self) -> Any:
        return self._client.call("viewer.workspace.layout.get")
    ...
    def set_layout(
        ...
        *,
        split: str | None = None,
        viewports: Iterable[Viewport | str] | None = None,
        ...
        if viewports is not None:
            params["viewports"] = [
                item.id if isinstance(item, Viewport) else item for item in viewports
            ]
    ...
    def swap(self, *, if_revision: int | None = None) -> Any:
        return self._client.call(
            "viewer.workspace.swap", _with_revision({}, if_revision)
        )

    def get_links(self) -> Any:
        return self._client.call("viewer.viewport_links.get")
...
class ViewportLinks:
    """Canonical resource for the milestone's fixed comparison link group."""
    ...
    def _fields(fields: Iterable[str]) -> list[str]:
        ...
        # Selection identity is shared by the document in this milestone.
        if "selection" not in result:
            result.append("selection")
        return result

    @staticmethod
    def _viewport_ids(viewports: Iterable[Viewport | str]) -> list[str]:
        return [item.id if isinstance(item, Viewport) else item for item in viewports]

    def list(self) -> Any:
        return self._client.call("viewer.viewport_links.list")

    def create(
        self,
        *,
        viewports: Iterable[Viewport | str],
...
class Viewports:
    ...
    def list(self) -> Any:
        return self._client.call("viewer.viewports.list")

    def handle(self, viewport_id: str) -> Viewport:
        return Viewport(self._client, viewport_id)

    def active(self) -> Viewport:
        workspace = self._client.call("viewer.workspace.get")
        return self.handle(str(workspace["active_viewport_id"]))

    def create(
        self,
        *,
        source: Viewport | str | None = None,
        title: str | None = None,
        ...
        if source is not None:
            params["source_viewport_id"] = (
                source.id if isinstance(source, Viewport) else source
            )
    ...
    def clone(
        ...
        *,
        ...
        params: dict[str, Any] = {
            "viewport_id": source.id if isinstance(source, Viewport) else source,
            "layout": layout,
            "activate": activate,
        }
        if ratio is not None:
    ...
    def compare(
        ...
        *,
        ...
        if unknown:
            raise ValueError(f"unknown linked fields: {sorted(unknown)}")
        left = self.active()
        renamed = left.rename(titles[0], if_revision=if_revision)
        ...
        ViewportLinks(self._client).create(
            viewports=[left, right],
            fields=fields,
            if_revision=next_revision,
        )
        return ViewportComparison(left, right)
    ...
    def capture(
        ...
        *,
        ...
        if viewport is not None:
            params["viewport_id"] = (
                viewport.id if isinstance(viewport, Viewport) else viewport
            )
        return self._client.call(
...
class Objects:
    ...
    def get_segmentation_geojson_source(self) -> Any:
        return self._client.call("viewer.segmentation_geojson.source.get")

    def load_segmentation_geojson(
        self,
        path: str | Path,
        *,
        downsample_factor: float = 1.0,
    ...
    def reload_segmentation_geojson(self, *, if_revision: int | None = None) -> Any:
        return self._client.tasks.start(
    ...
    def clear_segmentation_geojson(self, *, if_revision: int | None = None) -> Any:
        return self._client.call(
